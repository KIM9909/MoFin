...
SSAFY에 입과 하기 전과 지금의 저를 비교해서 돌아본다면 정말 많은 성장을 이뤄냈다라고 스스로 자부할 수 있을 것만 같습니다. 

정말 초반에는 적응을 하지못해 많이 깨지고 체력적으로나 심리적으로나 건강치 못했었습니다. 계속되는 실패와 좌절에 포기할까 주저도 많이 했었고, 무엇하나 제대로 해내지 못하는 스스로가 원망스러웠었습니다. 

하지만 그러면서도 주변에 노력으로 극복하는 동기들을 보며 더 열심히 해야겠다 생각을 했기 때문에 지금까지 성장하며 버텨올 수 있었던 것 같습니다. 

지금 현재도 진행하고 있는 첫 번째의 프로젝트도 과연 쉬운 것 하나 없었지만, 든든한 동료와 함께하여 많이 배울 수 있었고 성공리에 마무리할 수 있었던 것 같습니다. 

사람들과 교류하며 긍정적인 에너지를 나누고, 여러 대화를 통해 사고의 확장을 이뤄낸 것이 SSAFY에서의 가장 큰 수확이 아닐까 싶습니다.

앞으로도 더 큰 성장을 하기 위해 끊임없이 공부하며 실력을 키워 나가야할 것 같습니다.